...
- [ ] Step 1: 汇总 Week 39-45 review 状态，列出未完成项。
- [ ] Step 2: 确认所有 Deferred 能力边界仍准确。
- [ ] Step 3: 更新 version metadata 到 `0.3.0`。
- [ ] Step 4: 更新 CHANGELOG。
- [ ] Step 5: 更新 configuration、quickstart、security model、known limitations、capability status。
- [ ] Step 6: 更新 final acceptance，加入真实 agent 开发闭环验收清单。
...
- [ ] Step 11: 创建 `46_week_review.md` 和 `docs_md/release/final_acceptance_0.3.0.md`。
