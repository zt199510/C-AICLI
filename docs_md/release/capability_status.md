...
| Automation, pipelines, CI, daemon/API/SSE | Deferred | Local task queue v1 is available, but multi-role pipelines, automation schedules, CI/PR providers, daemon/API/SSE, concurrent workers, remote runners, and remote control are not enabled. |
