...
- Week 58-63 Project Pack contracts, discovery/plan, managed staging/checkpoint, controlled conversion, TIFF verification, managed preview/report evidence, artifact lifecycle, human acceptance, and safe resume/restart are 0.5.0 source-only Preview work. They are not included in the accepted 0.4.0 artifact and do not change the 0.4.0 release decision.
