...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe version
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe doctor
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe doctor --verbose
artifacts\release\caicli-0.2.0-win-x64\caicli.exe logs path
artifacts\release\caicli-0.2.0-win-x64\caicli.exe logs show --tail 20
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe logs clear
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe chat "Say hello in one sentence."
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe chat --session smoke "Remember this short note."
artifacts\release\caicli-0.2.0-win-x64\caicli.exe chat --resume smoke "What note did I ask you to remember?"
```
...
artifacts\release\caicli-0.2.0-win-x64\caicli.exe chat --workspace . "Say hello in this project's style."
```
...
artifacts\release\caicli-0.2.0-win-x64\caicli.exe chat --workspace . --cwd src\app "Draft a short implementation note."
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --workspace . --cwd src\app "Draft a short implementation note without changing files."
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe status --workspace .
artifacts\release\caicli-0.2.0-win-x64\caicli.exe models --workspace .
artifacts\release\caicli-0.2.0-win-x64\caicli.exe diff --workspace .
artifacts\release\caicli-0.2.0-win-x64\caicli.exe diff --stat --workspace .
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe review --workspace .
artifacts\release\caicli-0.2.0-win-x64\caicli.exe review --json --workspace .
artifacts\release\caicli-0.2.0-win-x64\caicli.exe review --output json --workspace .
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe mcp list
artifacts\release\caicli-0.2.0-win-x64\caicli.exe mcp doctor
artifacts\release\caicli-0.2.0-win-x64\caicli.exe workflow list
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --workspace . "read README.md"
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --json --workspace . "read README.md"
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --output json --workspace . "read README.md"
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --output text --workspace . "read README.md"
```

After model access is configured, pass `--trace` or set `CAICLI_TRACE=1` to write trace-level local JSONL diagnostics for `exec`:

```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --trace --workspace . "read README.md"
$env:CAICLI_TRACE = "1"
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --workspace . "read README.md"
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --workspace . --max-turns 4 --max-tool-calls 8 --timeout-seconds 60 "inspect README.md"
```

Use `--session` to record the transcript, including agent tool calls and summarized tool results:

```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --workspace . --session smoke-exec "inspect README.md"
artifacts\release\caicli-0.2.0-win-x64\caicli.exe exec --workspace . --resume smoke-exec "continue from the prior inspection"
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe run --workspace . --approve "create smoke note"
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe tools list --workspace .
```
...
```powershell
$toolList = artifacts\release\caicli-0.2.0-win-x64\caicli.exe tools list --workspace . --json | ConvertFrom-Json
$toolList.type
...
```powershell
@{ path = "README.md" } | ConvertTo-Json -Compress | artifacts\release\caicli-0.2.0-win-x64\caicli.exe tools call --workspace . workspace.read_text --stdin
```
...
artifacts\release\caicli-0.2.0-win-x64\caicli.exe tools call --workspace . workspace.read_text --arguments-file args.json
```
...
artifacts\release\caicli-0.2.0-win-x64\caicli.exe tools call --workspace . --approval always workspace.run_shell --arguments-file shell-args.json
```
...
```powershell
artifacts\release\caicli-0.2.0-win-x64\caicli.exe session list
artifacts\release\caicli-0.2.0-win-x64\caicli.exe session show smoke
artifacts\release\caicli-0.2.0-win-x64\caicli.exe session rename smoke smoke-archive
artifacts\release\caicli-0.2.0-win-x64\caicli.exe session export smoke-archive
artifacts\release\caicli-0.2.0-win-x64\caicli.exe session export --format markdown smoke-archive
artifacts\release\caicli-0.2.0-win-x64\caicli.exe session delete smoke-archive
```
