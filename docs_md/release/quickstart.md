...
```powershell
artifacts\release\caicli-0.3.3-win-x64\caicli.exe exec --record-job --job-name readme-review --workspace . "Summarize @file:README.md"
artifacts\release\caicli-0.3.3-win-x64\caicli.exe jobs list
artifacts\release\caicli-0.3.3-win-x64\caicli.exe jobs show <job-id> --output json
artifacts\release\caicli-0.3.3-win-x64\caicli.exe jobs export <job-id> --format markdown
```
