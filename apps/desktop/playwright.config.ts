...
export default defineConfig({
  ...
  projects: [
    { name: "unpacked", testMatch: /(?:read-only-shell|desktop-recovery|long-session|week76-hardening|chat-ui-visual|codex-parity-golden|full-pty|changes-write)\.spec\.ts/ },
